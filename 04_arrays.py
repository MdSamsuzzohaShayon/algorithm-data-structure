...
INSTEAD IT WOULD ALLOCATE 4 BLOCKS OF MEMORY TO INCREASE THE SIZE TO A TOTAL OF 4 CONTIGEOUS BLOCKS OF MEMORY
IT DOES THIS SO THAT IT DOESN'T HAVE TO RESIZE THE LIST EVERY SINGLE TIME WE ADD A ELEMENT BUT AT VERY SPECIFICE POINTS.
THE GROWTH PATTERN OF THE LIST TYPE IN PYTHON IS 0, 4, 8, 16, 25, 35, 46 AND SO ON
"""


# EXTENDS TAKES ANOTHER LIST TO ADD, 
# EXTEND EFFECTIVLY MAKES A SERIES OF APPEND CALLS ON EACH OF THE ELEMENTS IN THE NEW LIST UNTIL ALL OF THEM HAVE BEEN APPENDED TO THE ORIGINAL LIST
